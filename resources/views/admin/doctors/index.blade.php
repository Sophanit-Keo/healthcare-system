    ...
    <div class="table-card">
      <div class="search-bar">
        <div class="search-input-wrap">
          ...
          <input type="text" placeholder="Search by name or specialisationâ€¦">
        </div>
      ...
      <table class="data-table">
        ...
        <tbody>
          <tr>
            ...
            <td><span style="color:var(--amber);font-weight:600">â˜… 4.9</span></td>
          ...
          <tr>
            ...
            <td><span style="color:var(--amber);font-weight:600">â˜… 4.8</span></td>
          ...
          <tr>
            ...
            <td><span style="color:var(--amber);font-weight:600">â˜… 4.7</span></td>
      ...
      <div class="pagination">
        <span class="pagination-info">Showing 1â€“4 of 47 doctors</span>
