        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="bg-white shadow rounded-lg p-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="text-gray-900">{{ $encounter->patient?->user?->name ?? '-' }}</div>
                    </div>
                    <div>
                ...
                <div class="pt-4">
                    <a class="text-indigo-600 hover:text-indigo-700" href="{{ route('admin.encounters.index') }}">Back</a>
                </div>
            </div>
                ...
                <div class="mt-4 overflow-x-auto">
                    <table class="min-w-full text-sm">
                        ...
                        <tbody class="divide-y">
                            ...
                            @empty
                                <tr>
                                    <td class="p-6 text-center text-gray-500" colspan="5">No vital signs.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
            ...
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <div class="mt-4 space-y-3">
                    ...
                    @empty
                        <div class="text-sm text-gray-600">No lab orders.</div>
                    @endforelse
                </div>
            </div>
        </div>
