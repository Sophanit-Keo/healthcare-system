...
<div class="page-hero overlay-dark" style="background:linear-gradient(135deg,#0d2137 0%,#1a2a5e 100%);padding:60px 0 40px">
  <div class="container">
    <h1 style="color:#fff;margin-bottom:4px">Welcome, Dr. <?php echo e(Auth::user()->name); ?> 👋</h1>
        ...
        <div class="row">
              ...
              <div class="row">
                <div class="col-sm-6 mb-3">
                  <a href="#" style="display:block;padding:18px;background:linear-gradient(135deg,#EEF2FF,#dde4f7);border-radius:10px;text-decoration:none;color:#0d2137">
                    <strong style="font-size:16px">📋 View Patients</strong>
                ...
                <div class="col-sm-6 mb-3">
                  <a href="#" style="display:block;padding:18px;background:linear-gradient(135deg,#E8F7F3,#d1ede6);border-radius:10px;text-decoration:none;color:#0d2137">
                    <strong style="font-size:16px">📅 My Schedule</strong>
          ...
          <div class="col-lg-4 py-2">
            <div style="background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,.06);padding:28px;text-align:center">
              ...
              <h5 style="margin-bottom:4px;color:#18243a">Dr. <?php echo e(Auth::user()->name); ?></h5>
              <p class="text-grey" style="font-size:14px;margin-bottom:4px"><?php echo e(Auth::user()->email); ?></p>
              <p class="text-grey" style="font-size:13px;margin-bottom:16px">Doctor</p>
              <a href="<?php echo e(route('profile.edit')); ?>" class="btn btn-primary btn-sm" style="border-radius:8px">Edit Profile</a>
...
<?php echo $__env->make('layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\REACH\Desktop\Laravel assignment\resources\views/Doctor/dashboard.blade.php ENDPATH**/ ?>