                    ...
                    <div class="field-group mt-3">
                        ...
                        <div class="field-wrap">
                            <select
                                ...
                                name="user_type"
                                required
                                class="<?php echo e($errors->has('user_type') ? 'is-invalid' : ''); ?>">

                                <option value="">-- Select Role --</option>
                                <option value="patient" <?php echo e(old('user_type') == 'patient' ? 'selected' : ''); ?>>
                                    Patient
                                </option>
                                <option value="doctor" <?php echo e(old('user_type') == 'doctor' ? 'selected' : ''); ?>>
                                    Doctor
                                </option>
                            </select>
                        </div>
...
<?php /**PATH C:\Users\REACH\Desktop\Laravel assignment\resources\views/auth/register.blade.php ENDPATH**/ ?>