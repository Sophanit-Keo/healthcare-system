...
<div id="flash-msg" style="position:fixed;top:24px;right:24px;z-index:9999;background:<?php echo e(session('success') ? '#1a8a6e' : '#dc2626'); ?>;color:#fff;padding:14px 20px;border-radius:10px;font-size:.9rem;font-weight:500;box-shadow:0 6px 24px rgba(0,0,0,.15);max-width:380px;display:flex;align-items:center;gap:10px;opacity:0;transform:translateY(-8px);transition:all .35s ease">
...
<div class="db-hero">
  <div class="db-wrap">
    ...
    <p>Your health summary for <?php echo e(now()->format('l, d F Y')); ?></p>
  </div>
</div>
    ...
    <div class="db-wrap">
      ...
      <div class="db-stats">
        <div class="db-stat is-active" data-tab="appointments" onclick="dbTab('appointments')">
          ...
          <div>
            <div class="db-stat-num"><?php echo e($appointments->where('status', '!=', 'cancelled')->count()); ?></div>
        ...
        <div class="db-stat" data-tab="prescriptions" onclick="dbTab('prescriptions')">
          ...
          <div>
            <div class="db-stat-num"><?php echo e($prescriptions->count()); ?></div>
        ...
        <div class="db-stat" data-tab="records" onclick="dbTab('records')">
          ...
          <div>
            <div class="db-stat-num"><?php echo e($medicalRecords->count()); ?></div>
        ...
        <div class="db-stat" data-tab="messages" onclick="dbTab('messages')">
          ...
          <div>
            <div class="db-stat-num"><?php echo e($unreadMessages->count()); ?></div>
      ...
      <div class="db-layout">
        ...
        <div>
          <div class="db-card">
            ...
            <div class="db-actions">
              <a href="<?php echo e(route('home')); ?>#appointment" class="db-action">
              ...
              <a href="<?php echo e(route('home')); ?>#our_doctor" class="db-action">
              ...
              <a href="<?php echo e(route('patient.chat')); ?>" class="db-action">
              ...
              <a href="<?php echo e(route('patient.records')); ?>" class="db-action">
              ...
              <a href="<?php echo e(route('patient.lab-test')); ?>" class="db-action">
              ...
              <a href="<?php echo e(route('patient.lab-results')); ?>" class="db-action">
          ...
          <div class="db-panel is-active" id="panel-appointments">
            <div class="db-card">
              ...
              <div class="db-empty">
                ...
                <p>No appointments scheduled.<br><a href="<?php echo e(route('home')); ?>#appointment">Book one now &rarr;</a></p>
              </div>
              <?php else: ?>
              <div class="db-list">
                ...
                <div class="db-item">
                  <div class="db-item-ico" style="background:<?php echo e($appt->status === 'confirmed' ? '#e8f7f3' : ($appt->status === 'cancelled' ? '#fef2f2' : '#fffbeb')); ?>">
                    <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="<?php echo e($appt->status === 'confirmed' ? '#1a8a6e' : ($appt->status === 'cancelled' ? '#dc2626' : '#d97706')); ?>" stroke-width="2">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                    </svg>
                  </div>
                  <div class="db-item-body">
                    <div class="db-item-title"><?php echo e($appt->department); ?></div>
                    <div class="db-item-sub">
                      <?php echo e($appt->date->format('d M Y')); ?><?php echo e($appt->time ? ', '.$appt->time : ''); ?>

                      <?php if($appt->doctor): ?> &mdash; Dr. <?php echo e($appt->doctor); ?><?php endif; ?>
                    </div>
                  </div>
                  <span class="db-badge badge-<?php echo e($appt->status === 'confirmed' ? 'confirmed' : ($appt->status === 'cancelled' ? 'cancelled' : 'pending')); ?>">
            ...
            <div class="db-card">
              ...
              <div class="db-list">
                ...
                <div class="db-item">
                  ...
                  <div class="db-item-body">
                    <div class="db-item-title"><?php echo e($rx->medication); ?></div>
                    <div class="db-item-sub"><?php echo e($rx->dosage); ?> &mdash; <?php echo e($rx->frequency); ?></div>
                    <div class="db-item-sub">Dr. <?php echo e($rx->doctor_name); ?> &middot; <?php echo e($rx->start_date->format('d M Y')); ?><?php echo e($rx->end_date ? ' to '.$rx->end_date->format('d M Y') : ''); ?></div>
                  </div>
            ...
            <div class="db-card">
              ...
              <div class="db-list">
                ...
                <div class="db-item">
                  ...
                  <div class="db-item-body">
                    <div class="db-item-title"><?php echo e($record->title); ?></div>
                    <div class="db-item-sub"><?php echo e(ucfirst($record->type)); ?> &middot; <?php echo e($record->department); ?></div>
                    <div class="db-item-sub">Dr. <?php echo e($record->doctor_name); ?> &middot; <?php echo e($record->record_date->format('d M Y')); ?></div>
                  </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </div>
          ...
          <div class="db-panel" id="panel-messages">
            <div class="db-card">
              ...
              <?php else: ?>
              <div class="db-list">
                <?php $__currentLoopData = $unreadMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="db-item">
                  ...
                  <div class="db-item-body">
                    <div class="db-item-title"><?php echo e($msg->subject); ?></div>
                    <div class="db-item-sub"><?php echo e(Str::limit($msg->body, 80)); ?></div>
                    <div class="db-item-sub"><?php echo e($msg->created_at->diffForHumans()); ?></div>
                  </div>
        ...
        <div>
          <div class="db-card" style="text-align:center">
            <div class="db-profile-initial"><?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?></div>
            <p class="db-name"><?php echo e(Auth::user()->name); ?></p>
            <p class="db-email"><?php echo e(Auth::user()->email); ?></p>
            <span class="db-role-tag">Patient</span>
            <a href="<?php echo e(route('profile.edit')); ?>" class="btn btn-primary" style="width:100%;justify-content:center;padding:10px 0;font-size:.88rem;border-radius:8px">Edit Profile</a>
          ...
          <div class="db-card" style="margin-top:16px">
            ...
            <div style="display:flex;flex-direction:column;gap:8px">
              <div style="display:flex;justify-content:space-between;font-size:.82rem">
                ...
                <span style="color:#18243a;font-weight:500"><?php echo e(Auth::user()->phone ?? '—'); ?></span>
              </div>
              <div style="display:flex;justify-content:space-between;font-size:.82rem">
                <span style="color:#94a3b8">Member since</span>
                <span style="color:#18243a;font-weight:500"><?php echo e(Auth::user()->created_at->format('M Y')); ?></span>
              </div>
              <div style="display:flex;justify-content:space-between;font-size:.82rem">
...
<?php echo $__env->make('layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\REACH\Desktop\Laravel assignment\resources\views/dashboard.blade.php ENDPATH**/ ?>